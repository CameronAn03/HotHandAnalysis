...
1. Randomly permute the shot sequences within the 100 sampled player-games to simulate independent shots. All variables pertaining to each shot should be held constant, with only the order of shots being permuted.
