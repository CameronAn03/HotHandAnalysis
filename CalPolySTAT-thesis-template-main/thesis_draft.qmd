...
A logistic hierarchical model was constructed to evaluate the probability of a successful shot based on specific in-game variables and random effects. The variables and random effects are outlined in Table __.

$y_{ij} = \beta_0 + \beta_1{opportunity_{ij}} + \mu_{0j} + \mu_{1j}opportunity_{ij} + \epsilon_{ij}$
