...
\begin{align*}
\text{logit}(y_{ijk}) &= \beta_0 + \beta_1 \, opportunity_{ij} + u_{0j} + u_{1j} \, opportunity_{ij} + \epsilon_{ij} \\
...
var_table <- data.frame(
  Variable = c("make", "intercept", "is_opportunity", "dist_category", "is_opportunity*dist_category",
               "(1 | player)", "(is_opportunity | player)",
               "(1 | player)"),
  Description = c(
    "Baseline shot distance",
    "Indicator for whether a shot was made (1 = make, 0 = miss)",
    "Indicator for opportunity shot (1 = yes, 0 = no)",
    "Categorical shot distance (Close, Mid-range, Three-Pointer)",
    "Interaction between is_opportunity and dist_category",
...
coef_table <- data.frame(
  Coefficient = c(
    "Intercept",
    "is_opportunity",
    "dist_categoryMidrange",
    "dist_categoryThreePoint",
    "is_opportunity:dist_categoryMidrange",
    "is_opportunity:dist_categoryThreePoint"
  ),
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{figures/AppendixNullStats.png}
\caption{Observed and Null Statistics for Stratified Games.}
\label{fig:null-stats-stratified}
\end{figure}
