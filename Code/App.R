...
# Ross, K.J. (2016) "Classroom Investigations of Recent Research
# Concerning the Hot Hand Phenomenon". Working paper, Oct 2016.
...
max_streak_length = 7  # maximum allowable streak length
